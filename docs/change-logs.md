...
#### New Features
- Support [docker installation](https://shzlw.github.io/poleo/#/installation?id=docker).
...
- Fixes an issue that the query preview returns too many records. Now the number of records returned is limited to a configurable value(poleo.maximum-query-records)
